# alguns algoritmos precissam de desenhar de formas especificas por questoes de performance, insertino_sort
from drawlib import vertical_range, troca, substitui
from drawlib import set_pixel, show_screen, branco
